...
"""Export to HTML via a headless browser"""
...
class WebHTMLExporter(HTMLExporter):
    """Writer designed to write to HTML files, as manipulated from a web browser.

    This inherits from :class:`HTMLExporter`. It creates the HTML using the
    template machinery, and then run playwright to create an html file.
    """

    export_from_notebook = "HTML via Web"
    ...
    def from_notebook_node(self, nb, resources=None, **kw):
        ...
        self.log.info("Building HTML via headless browser")
