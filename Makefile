...
build:  ## build a sample pdf report
	jupyter nbconvert --to pdf sample.ipynb --template nbcx_templates/templates/reports/abc.tex.j2 && open sample.pdf
...
tex:  ## build a sample latext report
	jupyter nbconvert --to latex sample.ipynb --template nbcx_templates/templates/reports/abc.tex.j2
