...
# -*- coding: utf-8 -*-
#
# nbcx documentation build configuration file, created by
...
_version_py = os.path.join('..', 'nbcx', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'nbcx.tex', 'nbcx Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'nbcx', 'nbcx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nbcx', 'nbcx Documentation',
     author, 'nbcx', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    nbcx_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'nbcx'))
