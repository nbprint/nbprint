...
latex_documents = [
    (master_doc, "nbcx.tex", "nbcx Documentation", "Tim Paine", "manual"),
]
...
man_pages = [(master_doc, "nbcx", "nbcx Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    subprocess.check_call([cmd_path, "-E", "-M", "-o", out_dir, nbcx_dir, "--force"])
