...
# -*- coding: utf-8 -*-
#
# nbcx_templates documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.coverage', 'sphinx.ext.viewcode', 'sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'recommonmark', 'sphinx_markdown_tables']
...
_version_py = os.path.join('..', 'nbcx_templates', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'nbcx_templatesdoc'
...
latex_documents = [
    (master_doc, 'nbcx_templates.tex', 'nbcx_templates Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'nbcx_templates', 'nbcx_templates Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nbcx_templates', 'nbcx_templates Documentation',
     author, 'nbcx_templates', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    nbcx_templates_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'nbcx_templates'))
